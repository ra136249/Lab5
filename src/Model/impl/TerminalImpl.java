...
public class TerminalImpl extends MinimalEObjectImpl.Container implements Terminal {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ModelPackage.TERMINAL___ADICIONA_EXEMPLAR:
				adicionaExemplar();
				return null;
			case ModelPackage.TERMINAL___REMOVE_EXEMPLAR:
				removeExemplar();
				return null;
			case ModelPackage.TERMINAL___ATUALIZA_EXEMPLAR:
				atualizaExemplar();
				return null;
			case ModelPackage.TERMINAL___CADASTRA_USUARIO:
				cadastraUsuario();
				return null;
			case ModelPackage.TERMINAL___REMOVE_USUARIO:
				removeUsuario();
				return null;
